...
namespace ExamenED1EV2324
{
    public partial class Form1 : Form
    {
        ...
        int divisionRestas(int dividendoODGM2324, int divisorODGM2324)
        {
            ...
            //
            while (dividendoODGM2324 >= divisorODGM2324)
            {
                    //divisorODGM2324 -= dividendoODGM2324;
                    dividendoODGM2324 -= divisorODGM2324;  
                    cont++;
            }
        ...
        private void btDividir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int dividendoODGM2324, divisorODGM2324, resultado;

                // Leemos los valores del cuadro de texto.
                dividendoODGM2324 = int.Parse(txtDividendo.Text);
                divisorODGM2324 = int.Parse(txtDivisor.Text);

                // Comprobamos que el divisor no sea cero.
                if (divisorODGM2324 == 0)
                {
                    // Lanzamos una excepción.
                    throw new Exception("El divisor no puede ser cero.");
                }
                // Comprobamos que el divisor no sea mayor que el dividendo.
                if (dividendoODGM2324 < divisorODGM2324)
                {
                    // Lanzamos una excepción.
                ...
                resultado = divisionRestas(dividendoODGM2324, divisorODGM2324);

                // Mostramos el resultado.
                MessageBox.Show("El resultado de dividir " + dividendoODGM2324 + " entre " + divisorODGM2324 + " es : " + resultado);
            }
