...
namespace ExamenED1EV2324
{
    public partial class Form1 : Form
    {
        ...
        int divisionRestas(int CGG2324_dividendo, int divisor_CGG2324)
        {
            ...
            //
            while (CGG2324_dividendo >= divisor_CGG2324)
            {
                    CGG2324_dividendo -=divisor_CGG2324;
                    cont++;
            }
        ...
        private void btDividir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int CGG2324_dividendo, divisor_CGG2324, resultado;

                // Leemos los valores del cuadro de texto.
                CGG2324_dividendo = int.Parse(txtDividendo.Text);
                divisor_CGG2324 = int.Parse(txtDivisor.Text);

                // Comprobamos que el divisor no sea cero.
                if (divisor_CGG2324 == 0)
                {
                    // Lanzamos una excepción.
                    throw new Exception("El divisor no puede ser cero.");
                }
                // Comprobamos que el divisor no sea mayor que el dividendo.
                if ((CGG2324_dividendo < divisor_CGG2324)&&(CGG2324_dividendo == divisor_CGG2324))
                {
                    // Lanzamos una excepción.
                ...
                resultado = divisionRestas(CGG2324_dividendo, divisor_CGG2324);

                // Mostramos el resultado.
                MessageBox.Show("El resultado de dividir " + CGG2324_dividendo + " entre " + divisor_CGG2324 + " es : " + resultado);
            }
