...
namespace ExamenED1EV2324
{
    public partial class Form1 : Form
    {
        ...
        int divisionRestas(int dividendoJCBP2324, int divisorJCBP2324)
        {
            ...
            //
            while (dividendoJCBP2324 >= divisorJCBP2324)
            {
                    dividendoJCBP2324 -= divisorJCBP2324;
                    cont++;
            }
        ...
        private void btDividir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int dividendoJCBP2324, divisorJCBP2324, resultado;

                // Leemos los valores del cuadro de texto.
                dividendoJCBP2324 = int.Parse(txtDividendo.Text);
                divisorJCBP2324 = int.Parse(txtDivisor.Text);

                // Comprobamos que el divisor no sea cero.
                if (divisorJCBP2324 == 0)
                {
                    // Lanzamos una excepción.
                    throw new Exception("El divisor no puede ser cero.");
                }
                // Comprobamos que el divisor no sea mayor que el dividendo.
                if (dividendoJCBP2324 < divisorJCBP2324)
                {
                    // Lanzamos una excepción.
                ...
                resultado = divisionRestas(dividendoJCBP2324, divisorJCBP2324);

                // Mostramos el resultado.
                MessageBox.Show("El resultado de dividir " + dividendoJCBP2324 + " entre " + divisorJCBP2324 + " es : " + resultado);
            }
